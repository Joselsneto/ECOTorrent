...
import os
import json
from ecotorrent_file import EcotorrentFile
...
if __name__ == '__main__':
  ...
  parser.add_argument("-pl", "--piece_length", type=int, help="Piece length in bytes, it's recommended to use size of 2^n, default = 65536.")
